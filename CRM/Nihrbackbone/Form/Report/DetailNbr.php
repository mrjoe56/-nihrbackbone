 ...
 * @copyright CiviCRM LLC (c) 2004-2019
 */
class CRM_Nihrbackbone_Form_Report_DetailNbr extends CRM_Report_Form {
  ...
  public function __construct() {
    ...
    $this->_columns = [
      ...
      'civicrm_country' => [
        ...
        'fields' => [
          'name' => ['title' => ts(' Country'), 'default' => FALSE],
        ],
        'order_bys' => [
      ...
      'civicrm_participant' => [
        ...
        'fields' => [
          ...
          'event_id' => ['title' => ts(' Event'), 'default' => FALSE],
