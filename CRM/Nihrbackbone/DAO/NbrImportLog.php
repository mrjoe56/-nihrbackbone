 ...
 * (GenCodeChecksum:8cc2e28ec62ec0b4cfa9a03acff6849d)
 */
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        'id' => [
          ...
          'description' => ts('Unique NbrImportLog ID'),
          'required' => TRUE,
        ...
        'import_id' => [
          ...
          'title' => ts('Unique import ID'),
          'description' => ts('Unique ID of the import job'),
          'maxlength' => 32,
        ...
        'filename' => [
          ...
          'type' => CRM_Utils_Type::T_STRING,
          'title' => ts('File Name'),
          'description' => ts('Name of the import file that is being logged'),
          'maxlength' => 128,
        ...
        'message_type' => [
          'name' => 'message_type',
          'type' => CRM_Utils_Type::T_STRING,
          'title' => ts('Message Type'),
          'description' => ts('Type of message (info, warning, error)'),
          'maxlength' => 128,
          'size' => CRM_Utils_Type::HUGE,
        ...
        'logged_date' => [
          ...
          'title' => ts('Date Message Logged'),
          'description' => ts('The date the message was logged'),
